...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Precision Auto Care. We\'d love to hear from you about scheduling a service appointment.',
  keywords: ['Contact Precision Auto Care', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about scheduling a service appointment? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">service@precisionautocare.com</p>
                    <p className="text-gray-600">support@precisionautocare.com</p>
                  </div>
                </div>
