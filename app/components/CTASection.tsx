...
export default function CTASection({ homepageContent }: CTASectionProps) {
  const title = (homepageContent as any)?.ctaTitle || 'Ready to Get Your Vehicle Fixed?'
  const description = (homepageContent as any)?.ctaDescription?.processed || ''
  const primaryLabel = (homepageContent as any)?.ctaPrimary || 'Schedule Service'
  const secondaryLabel = (homepageContent as any)?.ctaSecondary || 'View Coupons'
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-8">
        ...
        {description ? (
          ...
          <p className="text-primary-100 text-lg mb-10 max-w-2xl mx-auto">
            Our ASE-certified technicians are ready to help. Book your appointment today and experience the Apex difference.
          </p>
        )}
