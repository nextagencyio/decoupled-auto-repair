...
export default function HeroSection({ homepageContent }: HeroSectionProps) {
  const title = (homepageContent as any)?.heroTitle || (homepageContent as any)?.title || 'PRECISION AUTO CARE'
  const subtitle = (homepageContent as any)?.heroSubtitle || 'Expert diagnostics. Honest repairs. Built on trust.'
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: 'url(https://images.unsplash.com/photo-1486262715619-67b85e0b08d3?w=1920&q=80&fit=crop)',
        }}
      />
      {/* Dark Overlay */}
